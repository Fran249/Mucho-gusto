            ...
            cols="6" lg="3" md="4" sm="4" xl="2"  >
                <v-card style="border-radius: 10px;"  elevation="9" class="v-card">
                    <div >
                        ...
                        border-bottom-left-radius: 1px;" :src="card.src" width="100%" :height ="heightImg()" class="v-img-card">
                ...
                <v-card  style="border-radius: 10px;" elevation="9" height="250px" width="100%">
                    ...
                    <v-card-actions class="actions-card">
                        <div class="div-btn">
                                ...
                                border-top-right-radius: 1px;
                                border-bottom-right-radius: 1px;" 
                                icon @click="disminuirCantidad(card)" outlined color="#02265c" width="20" height="20" class="v-btn-sumrest">
                                    <v-icon>
                                        mdi-minus
                                    </v-icon>
                                </v-btn>
                                ...
                                border-bottom-left-radius: 1px;"  icon @click="aumentarCantidad(card)" outlined color="#02265c" width="20" height="20" class="v-btn-sumrest">
                                    <v-icon>
                                        mdi-plus
                                    </v-icon>
                                </v-btn>
